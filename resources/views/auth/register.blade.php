						...
						<div class="w-lg-500px p-10">
							...
							@csrf
								...
								<div class="text-center mb-11">
									...
									<!--end::Title-->
									<!--begin::Subtitle-->
									<div class="text-gray-500 fw-semibold fs-6">Con campañas sociales</div>
									<!--end::Subtitle=-->
								</div>
								<!--end::Heading-->
								...
								<div class="row g-3 mb-9">
									<div class="col-md-6">
										<a href="{{ route('auth.google') }}" class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
											<img alt="Logo de google" src="assets/logos/google-icon.svg" class="h-15px me-3" />Registrarse con Google
										</a>
									</div>
									<div class="col-md-6">
										<a href="{{ route('github.login') }}" class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
											...
											<img alt="Logo" src="assets/media/svg/brand-logos/apple-black-dark.svg" class="theme-dark-show h-16px me-3" />Registrarse con GitHub
										</a>
									</div>
								</div>
								<!--end::Login options-->
								...
								<div class="fv-row mb-3 mt-4">
									<label for="names" value="{{ __('Nombre') }}"></label>
									<input type="text" placeholder="Nombre" name="names" id="names" class="form-control bg-transparent" />
								</div>
								
								<div class="fv-row mb-3 mt-4">
									<label for="lastnames" value="{{ __('Apellidos') }}"></label>
									<input type="text" placeholder="Apellidos" name="lastnames" id="lastnames" class="form-control bg-transparent" />
								</div>
								
								<div class="fv-row mb-3 mt-4">
									<label for="email" value="{{ __('Email') }}"></label>
									<input type="email" placeholder="Email" name="email" id="email" class="form-control bg-transparent" />
								</div>
								
								<div class="fv-row mb-3 mt-4">
									<label for="password" value="{{ __('Contraseña') }}"></label>
									<input type="password" placeholder="Contraseña" name="password" autocomplete="off" id="password" class="form-control bg-transparent" />
								</div>
								
								<div class="fv-row mb-3 mt-4">
									<label for="password_confirmation" value="{{ __('Confirmar Contraseña') }}"></label>
									<input type="password" placeholder="Confirmar Contraseña" name="password_confirmation" autocomplete="off" id="password_confirmation" class="form-control bg-transparent" />
								</div>
								
								<div class="fv-row mb-3 mt-4">
									<label for="address" value="{{ __('Dirección') }}"></label>
									<input type="text" placeholder="Dirección" name="address" id="address" class="form-control bg-transparent" />
								</div>

								<!--begin::Submit button-->
								<div class="d-grid mb-10 mt-4 fv-row">
								...
								<a href="{{ route('login')}}" class="link-primary fw-semibold">Iniciar sesión</a></div>
								<!--end::Sign up-->
							</form>
							<!--end::Form-->
						</div>
