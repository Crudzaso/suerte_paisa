							...
							@csrf
								...
								<div class="row g-3 mb-9">
									...
									<div class="col-md-6">
										...
										<img alt="Logo de google" src="assets/logos/google-icon.svg" class="h-15px me-3" />Iniciar sesión con Google</a>
										<!--end::Google link=-->
									</div>
									<!--end::Col-->
									<!--begin::Col-->
									<div class="col-md-6">
										...
										<img alt="Logo" src="assets/media/svg/brand-logos/apple-black-dark.svg" class="theme-dark-show h-16px me-3" />Iniciar sesión con GitHub</a>
										<!--end::Google link=-->
									</div>
									<!--end::Col-->
								</div>
								...
								<!--begin::Input group=-->
									<div class="fv-row mb-8">
										...
										<input type="text" placeholder="Email" id="email " name="email" class="form-control bg-transparent block mt-1 w-full" />
									</div>
								<!--end::Input group=-->
								...
								<div class="text-gray-500 text-center fw-semibold fs-6">No tienes una cuenta? 
									<a href="{{ route('registro') }}" class="link-primary">Registrarse</a>
								</div>
