						...
						<div class="w-lg-500px p-10">
							...
							@csrf
								...
								<div class="text-center mb-10">
									...
									<!--end::Title-->
									<!--begin::Link-->
									<div class="text-gray-500 fw-semibold fs-6">Ingresa el email para recuperar tu contraseña.</div>
									<!--end::Link-->
								</div>
								<!--begin::Heading-->
								<!--begin::Input group=-->
								...
								<div class="d-flex flex-wrap justify-content-center pb-lg-0">
									...
									<a href="authentication/layouts/corporate/sign-in.html" class="btn btn-light">Cancelar</a>
								</div>
								<!--end::Actions-->
							</form>
							<!--end::Form-->
						...
						<div class="me-10">
							...
							<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-4 fs-7" data-kt-menu="true" id="kt_auth_lang_menu">
								...
								<div class="menu-item px-3">
									<a href="#" class="menu-link d-flex px-5" data-kt-lang="Español">
